...
#define TOPICO_PUBLISH   "MQTTRecebe"    //tópico MQTT de envio de informações para Broker
                                                   ...
                                                   //            de outra pessoa.
#define ID_MQTT  "CarrinhoTCC"     //id mqtt (para identificação de sessão)
...
// WIFI
const char* SSID = "Wen"; // SSID / nome da rede WI-FI que deseja se conectar
const char* PASSWORD = "dcba3210"; // Senha da rede WI-FI que deseja se conectar
...
void mqtt_callback(char* topic, byte* payload, unsigned int length) 
{
    ...
    if (msg.equals("L"))
    {
        ...
        digitalWrite(D5, LOW);
        digitalWrite(D6, LOW);
        //EstadoSaida = 'Carrinho andando para frente';
    }
